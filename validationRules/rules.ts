...
const nameRules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length <= 20 || 'Max 20 characters'];

const mobileNumberRules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length >= 9 || 'Min 9 characters', (value: string) => (value || '').length <= 13 || 'Max 13 characters'];

const code3Rules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length >= 2 || 'Min 2 characters', (value: string) => (value || '').length <= 3 || 'Max 3 characters'];

const code1Rules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length >= 1 || 'Min 1 characters', (value: string) => (value || '').length <= 1 || 'Max 1 characters'];

const descriptionRules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length <= 100 || 'Max 100 characters'];

const shortDescriptionRules: unknown[] = [(value: string) => !!value || 'Required.', (value: string) => (value || '').length <= 30 || 'Max 30 characters'];

const requireRules: unknown[] = [(value: string) => !!value || 'Required.'];

const numberRules: unknown[] = [
    (value: string) => !!value || 'Required',
    (value: string) => {
